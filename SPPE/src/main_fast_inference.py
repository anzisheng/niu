...
class InferenNet_fastRes50(nn.Module):
    def __init__(self, device = 'cuda', weights_file='Models/sppe/fast_res50_256x192_2.pth'):
        #'/home/anzisheng/projectx/xiaoniu_test/Models/sppe/fast_res50_256x192.pth'
        super().__init__()
        if (device == 'cuda'):
